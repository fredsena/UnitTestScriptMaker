...
{
    public class BusinessSegTableRegBilling
    {
        [Fact]
        public void DbScriptByTemplate_BusinessSegTableRegBilling()
        {
            string path = @"C:\BillingTESTMappings\";
            string filename = "DEPLOY_Script_Map_Billing_Countries_22-10-2021";
            string fileToSearch = @"C:\BillingTESTMappings\Script_Mapped_Billing_Countries.txt";
...
BEGIN
	BEGIN TRY
		...
		PRINT 'SUCCESS: ##number#: TableCode: #TableCode# billing to Countries: (#TableListDoubleQuoted#) were successfully mapped/inserted into BusinessTableTableRegion table'
	END TRY
	BEGIN CATCH
		PRINT 'FAILED: ##number#: TableCode: #TableCode# billing to Countries: (#TableListDoubleQuoted#) were NOT mapped/inserted into BusinessTableTableRegion due to: ' + ERROR_MESSAGE()
	END CATCH
END
";
        }
        ...
        {
            string path = @"C:\BillingTESTMappings\";
            string filename = "VALIDATE_Script_Map_Billing_Countries_22-10-2021";
            string fileToSearch = @"C:\BillingTESTMappings\Script_Mapped_Billing_Countries.txt";
...
IF ( EXISTS ( 
	...
	PRINT 'SUCCESS: ##number#: TableCode: #TableCode# billing to Countries: (#TableListDoubleQuoted#) were successfully mapped/inserted into BusinessTableTableRegion table'
ELSE
	PRINT 'FAILED: ##number#: TableCode: #TableCode# billing to Countries: (#TableListDoubleQuoted#) were NOT mapped/inserted into BusinessTableTableRegion'
";
        }
