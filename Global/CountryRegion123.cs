...
{
    public class BusinessTableTableRegion4081_TEST
    {
        [Fact]
        public void DEPLOY_BusinessTableTableRegion_TEST()
        {
            string path = @"C:\DATA-SCRIPTS\BillingTESTMappings\";
            string filename = "DEPLOY_Script_BusinessTableTableRegion_TEST_10-10-2022";
            string fileToSearch = @"C:\DATA-SCRIPTS\BillingTESTMappings\BusinessTableTableRegion.txt";
...
PRINT 'SUCCESS: ##number#: TableCode: #TableCode# TEST to Countries: (C2) were successfully mapped/inserted into BusinessTableTableRegion table'
...
";
        ...
        {
            string path = @"C:\DATA-SCRIPTS\BillingTESTMappings\";
            string filename = "VALIDATE_Script_BusinessTableTableRegion4081_TEST_10-10-2022";
...
IF ( EXISTS ( 
	...
	WHERE TableRegionId = @TableRegionId_#TableCode# 
		...
		AND BusinessTableId IN (
			...
			AND BSCR.TableRegionId = @TableRegionId_#TableCode#
			AND BSCR.AddressPurposeType = 'TEST' ) ))
	PRINT 'SUCCESS: ##number#: TableCode: #TableCode# TEST to Table: (C2) were successfully mapped/inserted into BusinessTableTableRegion table'
ELSE
	PRINT 'FAILED: ##number#: TableCode: #TableCode# TEST to Table: (C2) were NOT mapped/inserted into BusinessTableTableRegion'
";
        }
